...
apt-get install -y nginx nginx-common php7.0-fpm php7.0-common

# php7.0-dev php7.0-bz2 php7.0-curl php7.0-gd php7.0-imagick php7.0-imap php7.0-intl php7.0-json php7.0-mbstring php7.0-mcrypt php7.0-mysql php7.0-xml php7.0-xmlrpc php7.0-zip
