...
rm -rf $PROJECTROOT/vendor/c* && echo "delete" >> /root/report/build-report.txt
rm -rf $PROJECTROOT/vendor/d* && echo "delete" >> /root/report/build-report.txt
rm -rf $PROJECTROOT/vendor/e* && echo "delete" >> /root/report/build-report.txt
rm -rf $PROJECTROOT/vendor/f* && echo "delete" >> /root/report/build-report.txt
rm -rf $PROJECTROOT/vendor/g* && echo "delete" >> /root/report/build-report.txt
rm -rf $PROJECTROOT/vendor/i* && echo "delete" >> /root/report/build-report.txt
rm -rf $PROJECTROOT/vendor/l* && echo "delete" >> /root/report/build-report.txt
rm -rf $PROJECTROOT/vendor/m* && echo "delete" >> /root/report/build-report.txt
rm -rf $PROJECTROOT/vendor/n* && echo "delete" >> /root/report/build-report.txt
rm -rf $PROJECTROOT/vendor/p* && echo "delete" >> /root/report/build-report.txt
